...
const findDriversInRadius = async (key, latitude, longitude, mode, radius = 100, limit = 10) => {
    try {
...
export const findNearbyDrivers = async (latitude, longitude, mode, radius = 5, limit = 10) => {
    return await findDriversInRadius(ACTIVE_DRIVERS_KEY, latitude, longitude, mode, radius, limit);
};
